...
# 安装必要的软件包
apt-get update && apt-get install -y libnss3 libnotify4 libsecret-1-0 libgbm1 libasound2 fonts-wqy-zenhei gnutls-bin libglib2.0-dev libdbus-1-3 libgtk-3-0 libxss1 libxtst6 libatspi2.0-0 libx11-xcb1 ffmpeg unzip jq curl
apt autoremove -y
apt clean
